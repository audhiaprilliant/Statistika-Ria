...
<head>
  ...
  <title>Statistics Essay Competition</title>
</head>
...
<body>
 ...
 <div class="py-3 bg-light">
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                <h2 class="text-center mb-1 text-primary"><b><b>Dashboard SEC <?=@$nama?></b></b></h2>
            </div>
        </div>
    </div>
</div>
              ...
              <div class="col-md-10 col-sm-8">
                <div class="panel panel-primary " >                          
                  <div class="panel-body">
                    ...
                    <a href="Template/Template SEC.docx" class="btn btn-primary">Download Answer Sheet Template here! </a>
                  </div>                    
                </div>
              </div>
              ...
              <div class="col-md-10 col-sm-8">
                <div class="panel panel-primary " >                   
                  <div class="panel-body">
                    <br>
                    <div class="clients text-center wow fadeInUp" data-wow-duration="500ms" data-wow-delay="300ms">
                      <h2 class="text-center mb-1 text-primary py-3 bg-light"><b>Essay Submission</b></h2>
                    <div>
                    <form class="form-horizontal" enctype="multipart/form-data" action="ken.php" method="post">
                    <div class="row">
                      <div class="col-md-4"></div>
                        <div class="col-md-4 col-sm-12">
                          <div class="form-group" style="margin : 10px">
                          <label for="">File must be in PDF and it must be a final upload</label>   
                          <!--
                          <input type="file" name="esai" accept="application/pdf" >
                          <input type="submit" name="upload_esai" class="btn btn-primary" value="Upload">
                        -->
                          </div>
                        </div>
                        <div class="col-md-4"></div>
